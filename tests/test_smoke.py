...
from habit_garden.cli import main
from habit_garden.models import Note, ProjectState, Task
from habit_garden.cli import demo_state
from habit_garden.storage import load_state, save_state
from habit_garden.models import generate_short_id
from habit_garden.validation import normalize_tags, require_text, validate_task_status
from habit_garden.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
